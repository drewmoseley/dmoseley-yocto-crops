...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y libegl1-mesa libsdl1.2-dev pylint3 xterm python3-subunit mesa-common-dev zstd liblz4-tool
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y sudo apt-utils python2.7 locales python-is-python3 libmd0 libmd-dev default-jre dialog libncurses-dev
...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y p7zip-full docker.io jq emacs tmux keychain pass rsync bc
